...
/**
 * The port on which the server will listen. Defaults to 5175.
 * @type {number}
 */
export const port = parseInt(process.env.SERVER_PORT || "5175", 10);
 ...
 */
export const clientId = process.env.CLIENT_ID || "checklist";
