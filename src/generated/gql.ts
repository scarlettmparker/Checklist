 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createChecklistFromTemplate($templateId: ID!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId, name: $name) {\n      message\n      entry {\n        id\n        name\n        dueAt\n        completedAt\n        status\n        createdAt\n        updatedAt\n      }\n    }\n  }\n}"): (typeof documents)["mutation createChecklistFromTemplate($templateId: ID!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId, name: $name) {\n      message\n      entry {\n        id\n        name\n        dueAt\n        completedAt\n        status\n        createdAt\n        updatedAt\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createChecklistFromTemplates($templateIds: [ID!]!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplates(templateIds: $templateIds, name: $name) {\n      message\n      entry {\n        id\n        name\n        dueAt\n        completedAt\n        status\n        createdAt\n        updatedAt\n      }\n    }\n  }\n}"): (typeof documents)["mutation createChecklistFromTemplates($templateIds: [ID!]!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplates(templateIds: $templateIds, name: $name) {\n      message\n      entry {\n        id\n        name\n        dueAt\n        completedAt\n        status\n        createdAt\n        updatedAt\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation deleteChecklist($id: ID!) {\n  checklistMutations {\n    deleteChecklist(id: $id) {\n      message\n      id\n    }\n  }\n}"): (typeof documents)["mutation deleteChecklist($id: ID!) {\n  checklistMutations {\n    deleteChecklist(id: $id) {\n      message\n      id\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation detachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    detachObject(source: $source, target: $target, ownerType: $ownerType) {\n      message\n      id\n    }\n  }\n}"): (typeof documents)["mutation detachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    detachObject(source: $source, target: $target, ownerType: $ownerType) {\n      message\n      id\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query listChecklistEntryItems($entryId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    entryItems(entryId: $entryId, pagination: $pagination) {\n      items {\n        id\n        entryId\n        itemId\n        name\n        icon\n        status\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"): (typeof documents)["query listChecklistEntryItems($entryId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    entryItems(entryId: $entryId, pagination: $pagination) {\n      items {\n        id\n        entryId\n        itemId\n        name\n        icon\n        status\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query listChecklistItems($pagination: PaginationInput) {\n  checklistQueries {\n    items(pagination: $pagination) {\n      items {\n        id\n        name\n        description\n        icon\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"): (typeof documents)["query listChecklistItems($pagination: PaginationInput) {\n  checklistQueries {\n    items(pagination: $pagination) {\n      items {\n        id\n        name\n        description\n        icon\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query listChecklistTemplateItems($templateId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    templateItems(templateId: $templateId, pagination: $pagination) {\n      items {\n        id\n        templateId\n        itemId\n        name\n        icon\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"): (typeof documents)["query listChecklistTemplateItems($templateId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    templateItems(templateId: $templateId, pagination: $pagination) {\n      items {\n        id\n        templateId\n        itemId\n        name\n        icon\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query locateGalleryItems($ids: [ID!]!) {\n  galleryQueries {\n    locateGalleryItems(ids: $ids) {\n      id\n      title\n      description\n      imagePath\n    }\n  }\n}"): (typeof documents)["query locateGalleryItems($ids: [ID!]!) {\n  galleryQueries {\n    locateGalleryItems(ids: $ids) {\n      id\n      title\n      description\n      imagePath\n    }\n  }\n}"];
