...
type Documents = {
  ...
  "mutation createChecklistItem($name: String!, $description: String, $categoryId: ID) {\n  checklistMutations {\n    createItem(name: $name, description: $description, categoryId: $categoryId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.CreateChecklistItemDocument;
 ...
 */
export function graphql(
  source: "mutation createChecklistFromTemplate($templateId: ID!) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistFromTemplate($templateId: ID!) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistItem($name: String!, $description: String, $categoryId: ID) {\n  checklistMutations {\n    createItem(name: $name, description: $description, categoryId: $categoryId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistItem($name: String!, $description: String, $categoryId: ID) {\n  checklistMutations {\n    createItem(name: $name, description: $description, categoryId: $categoryId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "query listChecklistItems($page: Int, $size: Int, $sortBy: String, $sortDir: String) {\n  checklistQueries {\n    items(page: $page, size: $size, sortBy: $sortBy, sortDir: $sortDir) {\n      items {\n        id\n        name\n        description\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      totalCount\n      page\n      size\n      totalPages\n    }\n  }\n}",
): (typeof documents)["query listChecklistItems($page: Int, $size: Int, $sortBy: String, $sortDir: String) {\n  checklistQueries {\n    items(page: $page, size: $size, sortBy: $sortBy, sortDir: $sortDir) {\n      items {\n        id\n        name\n        description\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      totalCount\n      page\n      size\n      totalPages\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistTemplateItems($templateId: ID!) {\n  checklistQueries {\n    templateItems(templateId: $templateId) {\n      id\n      templateId\n      itemId\n      position\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation setChecklistItemStatus($entryId: ID!, $itemId: ID!, $status: String!) {\n  checklistMutations {\n    setItemStatus(entryId: $entryId, itemId: $itemId, status: $status) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation setChecklistItemStatus($entryId: ID!, $itemId: ID!, $status: String!) {\n  checklistMutations {\n    setItemStatus(entryId: $entryId, itemId: $itemId, status: $status) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
