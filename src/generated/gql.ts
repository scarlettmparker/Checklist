...
type Documents = {
  ...
  "mutation createChecklistFromTemplate($templateId: ID!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.CreateChecklistFromTemplateDocument;
  "mutation createChecklistFromTemplates($templateIds: [ID!]!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplates(templateIds: $templateIds, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.CreateChecklistFromTemplatesDocument;
  ...
  "mutation deleteChecklist($id: ID!) {\n  checklistMutations {\n    deleteChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.DeleteChecklistDocument;
  "mutation detachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    detachObject(source: $source, target: $target, ownerType: $ownerType) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.DetachChecklistObjectDocument;
  ...
  "query listChecklistEntryItems($entryId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    entryItems(entryId: $entryId, pagination: $pagination) {\n      items {\n        id\n        entryId\n        itemId\n        name\n        icon\n        status\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ListChecklistEntryItemsDocument;
  "query listChecklistItems($pagination: PaginationInput) {\n  checklistQueries {\n    items(pagination: $pagination) {\n      items {\n        id\n        name\n        description\n        icon\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ListChecklistItemsDocument;
  "query listChecklistTemplateItems($templateId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    templateItems(templateId: $templateId, pagination: $pagination) {\n      items {\n        id\n        templateId\n        itemId\n        name\n        icon\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ListChecklistTemplateItemsDocument;
...
const documents: Documents = {
  ...
  "mutation createChecklistFromTemplates($templateIds: [ID!]!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplates(templateIds: $templateIds, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.CreateChecklistFromTemplatesDocument,
  "mutation createChecklistItem($name: String!, $description: String, $categoryId: ID, $icon: String) {\n  checklistMutations {\n    createItem(\n      name: $name\n      description: $description\n      categoryId: $categoryId\n      icon: $icon\n    ) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.CreateChecklistItemDocument,
  "mutation createChecklistTemplate($name: String!, $description: String, $itemIds: [ID!]) {\n  checklistMutations {\n    createTemplate(name: $name, description: $description, itemIds: $itemIds) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.CreateChecklistTemplateDocument,
  "mutation deleteChecklist($id: ID!) {\n  checklistMutations {\n    deleteChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.DeleteChecklistDocument,
  "mutation detachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    detachObject(source: $source, target: $target, ownerType: $ownerType) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.DetachChecklistObjectDocument,
  "query listChecklistCategories {\n  checklistQueries {\n    listCategories {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}":
...
export function graphql(
  source: "mutation addChecklistItem($entryId: ID!, $itemId: ID!, $position: Int) {\n  checklistMutations {\n    addItem(entryId: $entryId, itemId: $itemId, position: $position) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation addChecklistItem($entryId: ID!, $itemId: ID!, $position: Int) {\n  checklistMutations {\n    addItem(entryId: $entryId, itemId: $itemId, position: $position) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation addChecklistTemplateItem($templateId: ID!, $itemId: ID!, $position: Int) {\n  checklistMutations {\n    addTemplateItem(templateId: $templateId, itemId: $itemId, position: $position) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation addChecklistTemplateItem($templateId: ID!, $itemId: ID!, $position: Int) {\n  checklistMutations {\n    addTemplateItem(templateId: $templateId, itemId: $itemId, position: $position) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation archiveChecklist($id: ID!) {\n  checklistMutations {\n    archiveChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation archiveChecklist($id: ID!) {\n  checklistMutations {\n    archiveChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation archiveChecklistTemplate($id: ID!) {\n  checklistMutations {\n    archiveTemplate(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation archiveChecklistTemplate($id: ID!) {\n  checklistMutations {\n    archiveTemplate(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation attachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    attachObject(source: $source, target: $target, ownerType: $ownerType) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation attachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    attachObject(source: $source, target: $target, ownerType: $ownerType) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation completeChecklist($id: ID!) {\n  checklistMutations {\n    completeChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation completeChecklist($id: ID!) {\n  checklistMutations {\n    completeChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistCategory($name: String!, $description: String) {\n  checklistMutations {\n    createCategory(name: $name, description: $description) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistCategory($name: String!, $description: String) {\n  checklistMutations {\n    createCategory(name: $name, description: $description) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistEntry($name: String) {\n  checklistMutations {\n    createChecklist(name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistEntry($name: String) {\n  checklistMutations {\n    createChecklist(name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistFromTemplate($templateId: ID!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistFromTemplate($templateId: ID!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplate(templateId: $templateId, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistFromTemplates($templateIds: [ID!]!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplates(templateIds: $templateIds, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistFromTemplates($templateIds: [ID!]!, $name: String) {\n  checklistMutations {\n    createChecklistFromTemplates(templateIds: $templateIds, name: $name) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistItem($name: String!, $description: String, $categoryId: ID, $icon: String) {\n  checklistMutations {\n    createItem(\n      name: $name\n      description: $description\n      categoryId: $categoryId\n      icon: $icon\n    ) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistItem($name: String!, $description: String, $categoryId: ID, $icon: String) {\n  checklistMutations {\n    createItem(\n      name: $name\n      description: $description\n      categoryId: $categoryId\n      icon: $icon\n    ) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createChecklistTemplate($name: String!, $description: String, $itemIds: [ID!]) {\n  checklistMutations {\n    createTemplate(name: $name, description: $description, itemIds: $itemIds) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createChecklistTemplate($name: String!, $description: String, $itemIds: [ID!]) {\n  checklistMutations {\n    createTemplate(name: $name, description: $description, itemIds: $itemIds) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteChecklist($id: ID!) {\n  checklistMutations {\n    deleteChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation deleteChecklist($id: ID!) {\n  checklistMutations {\n    deleteChecklist(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation detachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    detachObject(source: $source, target: $target, ownerType: $ownerType) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation detachChecklistObject($source: ID!, $target: ID!, $ownerType: RemoteObjectType) {\n  checklistMutations {\n    detachObject(source: $source, target: $target, ownerType: $ownerType) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistCategories {\n  checklistQueries {\n    listCategories {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query listChecklistCategories {\n  checklistQueries {\n    listCategories {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistEntries {\n  checklistQueries {\n    listEntries {\n      id\n      name\n      dueAt\n      completedAt\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query listChecklistEntries {\n  checklistQueries {\n    listEntries {\n      id\n      name\n      dueAt\n      completedAt\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistEntryItems($entryId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    entryItems(entryId: $entryId, pagination: $pagination) {\n      items {\n        id\n        entryId\n        itemId\n        name\n        icon\n        status\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query listChecklistEntryItems($entryId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    entryItems(entryId: $entryId, pagination: $pagination) {\n      items {\n        id\n        entryId\n        itemId\n        name\n        icon\n        status\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistItems($pagination: PaginationInput) {\n  checklistQueries {\n    items(pagination: $pagination) {\n      items {\n        id\n        name\n        description\n        icon\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query listChecklistItems($pagination: PaginationInput) {\n  checklistQueries {\n    items(pagination: $pagination) {\n      items {\n        id\n        name\n        description\n        icon\n        categoryId\n        lifecycleStatus\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistTemplateItems($templateId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    templateItems(templateId: $templateId, pagination: $pagination) {\n      items {\n        id\n        templateId\n        itemId\n        name\n        icon\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query listChecklistTemplateItems($templateId: ID!, $pagination: PaginationInput) {\n  checklistQueries {\n    templateItems(templateId: $templateId, pagination: $pagination) {\n      items {\n        id\n        templateId\n        itemId\n        name\n        icon\n        position\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listChecklistTemplates {\n  checklistQueries {\n    listTemplates {\n      id\n      name\n      description\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query listChecklistTemplates {\n  checklistQueries {\n    listTemplates {\n      id\n      name\n      description\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateChecklistEntry($id: ID!) {\n  checklistQueries {\n    entry(id: $id) {\n      id\n      name\n      dueAt\n      completedAt\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query locateChecklistEntry($id: ID!) {\n  checklistQueries {\n    entry(id: $id) {\n      id\n      name\n      dueAt\n      completedAt\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateChecklistEntryDetails($id: ID!) {\n  checklistQueries {\n    entryDetails(id: $id) {\n      ownerId\n      description\n      remoteObject\n    }\n  }\n}",
): (typeof documents)["query locateChecklistEntryDetails($id: ID!) {\n  checklistQueries {\n    entryDetails(id: $id) {\n      ownerId\n      description\n      remoteObject\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateChecklistItem($id: ID!) {\n  checklistQueries {\n    item(id: $id) {\n      id\n      name\n      description\n      icon\n      categoryId\n      lifecycleStatus\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query locateChecklistItem($id: ID!) {\n  checklistQueries {\n    item(id: $id) {\n      id\n      name\n      description\n      icon\n      categoryId\n      lifecycleStatus\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateChecklistItemDetails($id: ID!) {\n  checklistQueries {\n    itemDetails(id: $id) {\n      ownerId\n      description\n      remoteObject\n    }\n  }\n}",
): (typeof documents)["query locateChecklistItemDetails($id: ID!) {\n  checklistQueries {\n    itemDetails(id: $id) {\n      ownerId\n      description\n      remoteObject\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateChecklistTemplate($id: ID!) {\n  checklistQueries {\n    template(id: $id) {\n      id\n      name\n      description\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query locateChecklistTemplate($id: ID!) {\n  checklistQueries {\n    template(id: $id) {\n      id\n      name\n      description\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateChecklistTemplateDetails($id: ID!) {\n  checklistQueries {\n    templateDetails(id: $id) {\n      ownerId\n      description\n      remoteObject\n    }\n  }\n}",
): (typeof documents)["query locateChecklistTemplateDetails($id: ID!) {\n  checklistQueries {\n    templateDetails(id: $id) {\n      ownerId\n      description\n      remoteObject\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateRemoteObjects($ids: [String!]!) {\n  checklistQueries {\n    locateRemoteObjects(ids: $ids) {\n      id\n      ownerType\n      ownerId\n      description\n    }\n  }\n}",
): (typeof documents)["query locateRemoteObjects($ids: [String!]!) {\n  checklistQueries {\n    locateRemoteObjects(ids: $ids) {\n      id\n      ownerType\n      ownerId\n      description\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation removeChecklistItem($entryId: ID!, $itemId: ID!) {\n  checklistMutations {\n    removeItem(entryId: $entryId, itemId: $itemId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation removeChecklistItem($entryId: ID!, $itemId: ID!) {\n  checklistMutations {\n    removeItem(entryId: $entryId, itemId: $itemId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation removeChecklistTemplateItem($templateId: ID!, $itemId: ID!) {\n  checklistMutations {\n    removeTemplateItem(templateId: $templateId, itemId: $itemId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation removeChecklistTemplateItem($templateId: ID!, $itemId: ID!) {\n  checklistMutations {\n    removeTemplateItem(templateId: $templateId, itemId: $itemId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation retireChecklistItem($id: ID!) {\n  checklistMutations {\n    retireItem(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation retireChecklistItem($id: ID!) {\n  checklistMutations {\n    retireItem(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation saveChecklistCategory($input: ChecklistCategoryInput!) {\n  checklistMutations {\n    saveCategory(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation saveChecklistCategory($input: ChecklistCategoryInput!) {\n  checklistMutations {\n    saveCategory(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation saveChecklistEntry($input: ChecklistEntryInput!) {\n  checklistMutations {\n    saveChecklist(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation saveChecklistEntry($input: ChecklistEntryInput!) {\n  checklistMutations {\n    saveChecklist(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation saveChecklistItem($input: ChecklistItemInput!) {\n  checklistMutations {\n    saveItem(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation saveChecklistItem($input: ChecklistItemInput!) {\n  checklistMutations {\n    saveItem(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation saveChecklistTemplate($input: ChecklistTemplateInput!) {\n  checklistMutations {\n    saveTemplate(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation saveChecklistTemplate($input: ChecklistTemplateInput!) {\n  checklistMutations {\n    saveTemplate(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation setChecklistItemStatus($entryId: ID!, $itemId: ID!, $status: ItemStatus!) {\n  checklistMutations {\n    setItemStatus(entryId: $entryId, itemId: $itemId, status: $status) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation setChecklistItemStatus($entryId: ID!, $itemId: ID!, $status: ItemStatus!) {\n  checklistMutations {\n    setItemStatus(entryId: $entryId, itemId: $itemId, status: $status) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteFile($input: BucketKeyInput!) {\n  filestoreMutations {\n    deleteFile(input: $input)\n  }\n}",
): (typeof documents)["mutation deleteFile($input: BucketKeyInput!) {\n  filestoreMutations {\n    deleteFile(input: $input)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation getPresignedUploadUrl($input: PresignInput!) {\n  filestoreMutations {\n    getPresignedUploadUrl(input: $input)\n  }\n}",
): (typeof documents)["mutation getPresignedUploadUrl($input: PresignInput!) {\n  filestoreMutations {\n    getPresignedUploadUrl(input: $input)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation getPresignedUploadUrls($input: [PresignInput!]!) {\n  filestoreMutations {\n    getPresignedUploadUrls(input: $input)\n  }\n}",
 ...
 */
export function graphql(
  source: "query locateGalleryItems($ids: [ID!]!) {\n  galleryQueries {\n    locateGalleryItems(ids: $ids) {\n      id\n      title\n      description\n      imagePath\n    }\n  }\n}",
): (typeof documents)["query locateGalleryItems($ids: [ID!]!) {\n  galleryQueries {\n    locateGalleryItems(ids: $ids) {\n      id\n      title\n      description\n      imagePath\n    }\n  }\n}"];
